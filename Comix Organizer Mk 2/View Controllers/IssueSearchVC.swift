...
class IssueSearchVC: CODataLoadingVC
{
...
extension IssueSearchVC: UICollectionViewDelegate
{
...
extension IssueSearchVC: UISearchResultsUpdating, UISearchBarDelegate
{
