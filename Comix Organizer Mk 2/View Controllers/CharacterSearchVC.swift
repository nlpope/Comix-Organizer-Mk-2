...
class CharacterSearchVC: CODataLoadingVC
{
...
extension CharacterSearchVC: UICollectionViewDelegate
{
...
extension CharacterSearchVC: UISearchResultsUpdating, UISearchBarDelegate
{
