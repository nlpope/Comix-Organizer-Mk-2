...
class TitleSearchVC: CODataLoadingVC
{
...
extension TitleSearchVC: UICollectionViewDelegate
{
...
extension TitleSearchVC: UISearchResultsUpdating, UISearchBarDelegate
{
