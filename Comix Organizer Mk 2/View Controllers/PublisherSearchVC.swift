...
class PublisherSearchVC: CODataLoadingVC
{
...
extension PublisherSearchVC: UICollectionViewDelegate
{
...
extension PublisherSearchVC: UISearchResultsUpdating, UISearchBarDelegate
{
